	...
	$.getScript('//connect.facebook.net/en_US/sdk.js', function(){
		...
		FB.api('/ucsdgradwic/photos?fields=images,link&type=uploaded', {
			...
			for (var i=0;i<6;i++) {
				...
				outputgallery+="<div class=\"col-lg-6 col-md-6 gallery-set\">";
				outputgallery+="<a href=\""+item[i].link+"\"><img src = \""+item[i].images[4].source+"\" style='width:90%; max-height:300px'  /></a></div>";
